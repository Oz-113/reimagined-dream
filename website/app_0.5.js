...
aktiv= mesag;
    ...
    case '#':
      ...
      if (currentWs) {
	      let messageToSend;
        if (currentEspId === 1) {
                       messageToSend = `1;${espData[`esp${currentEspId}`].pir};${espData[`esp${currentEspId}`].kapi};${espData[`esp${currentEspId}`].parlaklik};${espData[`esp${currentEspId}`].temperature};${aktiv}`; 
        } else if (currentEspId === 2) {
                       messageToSend = `2;${espData[`esp${currentEspId}`].pir};${espData[`esp${currentEspId}`].kapi};${espData[`esp${currentEspId}`].parlaklik};${espData[`esp${currentEspId}`].temperature};${aktiv}`; 
        } else if (currentEspId === 3) {
                       messageToSend = `3;${espData[`esp${currentEspId}`].pir};${espData[`esp${currentEspId}`].kapi};${espData[`esp${currentEspId}`].parlaklik};${espData[`esp${currentEspId}`].temperature};${aktiv}`;    
	      } else if (currentEspId === 4) {
                        messageToSend = `4;${espData[`esp${currentEspId}`].pir};${espData[`esp${currentEspId}`].kapi};${espData[`esp${currentEspId}`].parlaklik};${espData[`esp${currentEspId}`].temperature};${aktiv}`
        } else if (currentEspId === 5) {
                       messageToSend = `5;${espData[`esp${currentEspId}`].pir};${espData[`esp${currentEspId}`].kapi};${espData[`esp${currentEspId}`].parlaklik};${espData[`esp${currentEspId}`].temperature};${aktiv}`;        }
