  ...
  switch (dat) {
    ...
    case '#':
      ...
      if (currentWs) {
	      let messageToSend;
        if (currentEspId === 1) {
                       messageToSend = `ESP1;${espData[`esp${currentEspId}`].pir};${espData[`esp${currentEspId}`].temperature}`; 
        } else if (currentEspId === 2) {
                       messageToSend = `ESP2;${espData[`esp${currentEspId}`].pir};${espData[`esp${currentEspId}`].temperature}`; 
        } else if (currentEspId === 3) {
                       messageToSend = `ESP3;${espData[`esp${currentEspId}`].pir};${espData[`esp${currentEspId}`].temperature}`;    
	} else if (currentEspId === 4) {
                        messageToSend = `ESP4;${espData[`esp${currentEspId}`].pir};${espData[`esp${currentEspId}`].temperature}`
        } else if (currentEspId === 5) {
                       messageToSend = `ESP5;${espData[`esp${currentEspId}`].pir};${espData[`esp${currentEspId}`].temperature}`;        }
